...
// kalloc.c
void            kfree(void *);
void*           kalloc(void) __attribute__((malloc (kfree)));
void*           kalloc_zero(void) __attribute__((malloc (kfree)));
void            kinit(void);
...
void            schedule_proc(struct proc*);
...
uint64          print_pt(); // prints contents of a processes pagetable
void            uvmfreelevels(pagetable_t);
